...
namespace ShoppingMvc.Migrations
{
    public partial class init_db : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "SellerVisitorDatas",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SellerDataId = table.Column<int>(type: "int", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsArchived = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SellerVisitorDatas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SellerVisitorDatas_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SellerVisitorDatas_SellerDatas_SellerDataId",
                        column: x => x.SellerDataId,
                        principalTable: "SellerDatas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderTrackings_SellerDatas_SellerDataId",
                        column: x => x.SellerDataId,
                        principalTable: "SellerDatas",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVisitorDatas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductVisitorDatas_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductVisitorDatas_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderTrackings_SellerDataId",
                table: "OrderTrackings",
                column: "SellerDataId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVisitorDatas_ProductId",
                table: "ProductVisitorDatas",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductVisitorDatas_UserId",
                table: "ProductVisitorDatas",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SellerVisitorDatas_SellerDataId",
                table: "SellerVisitorDatas",
                column: "SellerDataId");

            migrationBuilder.CreateIndex(
                name: "IX_SellerVisitorDatas_UserId",
                table: "SellerVisitorDatas",
                column: "UserId");
        }
